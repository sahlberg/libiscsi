 ...
 * READTOC
 */
EXTERN struct scsi_task *scsi_cdb_readtoc(TALLOC_CTX *mem_ctx, int msf, int format, int track_session, uint16_t alloc_len);
 ...
 * TESTUNITREADY
 */
EXTERN struct scsi_task *scsi_cdb_testunitready(TALLOC_CTX *mem_ctx);
...
EXTERN struct scsi_task *scsi_cdb_reportluns(TALLOC_CTX *mem_ctx, int report_type, int alloc_len);

/*
 * RESERVE6
 */
EXTERN struct scsi_task *scsi_cdb_reserve6(TALLOC_CTX *mem_ctx);
/*
 * RELEASE6
 */
EXTERN struct scsi_task *scsi_cdb_release6(TALLOC_CTX *mem_ctx);
...
EXTERN struct scsi_task *scsi_cdb_readcapacity10(TALLOC_CTX *mem_ctx, int lba, int pmi);
...
EXTERN struct scsi_task *scsi_cdb_inquiry(TALLOC_CTX *mem_ctx, int evpd, int page_code, int alloc_len);
...
EXTERN struct scsi_task *scsi_cdb_modesense6(TALLOC_CTX *mem_ctx, int dbd,
...
EXTERN struct scsi_task *scsi_cdb_read6(TALLOC_CTX *mem_ctx, uint32_t lba, uint32_t xferlen, int blocksize);
EXTERN struct scsi_task *scsi_cdb_read10(TALLOC_CTX *mem_ctx, uint32_t lba, uint32_t xferlen, int blocksize, int rdprotect, int dpo, int fua, int fua_nv, int group_number);
EXTERN struct scsi_task *scsi_cdb_read12(TALLOC_CTX *mem_ctx, uint32_t lba, uint32_t xferlen, int blocksize, int rdprotect, int dpo, int fua, int fua_nv, int group_number);
EXTERN struct scsi_task *scsi_cdb_read16(TALLOC_CTX *mem_ctx, uint64_t lba, uint32_t xferlen, int blocksize, int rdprotect, int dpo, int fua, int fua_nv, int group_number);
EXTERN struct scsi_task *scsi_cdb_write10(TALLOC_CTX *mem_ctx, uint32_t lba, uint32_t xferlen, int blocksize, int wrprotect, int dpo, int fua, int fua_nv, int group_number);
EXTERN struct scsi_task *scsi_cdb_write12(TALLOC_CTX *mem_ctx, uint32_t lba, uint32_t xferlen, int blocksize, int wrprotect, int dpo, int fua, int fua_nv, int group_number);
EXTERN struct scsi_task *scsi_cdb_write16(TALLOC_CTX *mem_ctx, uint64_t lba, uint32_t xferlen, int blocksize, int wrprotect, int dpo, int fua, int fua_nv, int group_number);
EXTERN struct scsi_task *scsi_cdb_startstopunit(TALLOC_CTX *mem_ctx, int immed, int pcm, int pc, int no_flush, int loej, int start);
EXTERN struct scsi_task *scsi_cdb_preventallow(TALLOC_CTX *mem_ctx, int prevent);
EXTERN struct scsi_task *scsi_cdb_orwrite(TALLOC_CTX *mem_ctx, uint64_t lba, uint32_t xferlen, int blocksize, int wrprotect, int dpo, int fua, int fua_nv, int group_number);
EXTERN struct scsi_task *scsi_cdb_compareandwrite(TALLOC_CTX *mem_ctx, uint64_t lba, uint32_t xferlen, int blocksize, int wrprotect, int dpo, int fua, int fua_nv, int group_number);
EXTERN struct scsi_task *scsi_cdb_writeverify10(TALLOC_CTX *mem_ctx, uint32_t lba, uint32_t xferlen, int blocksize, int wrprotect, int dpo, int bytchk, int group_number);
EXTERN struct scsi_task *scsi_cdb_writeverify12(TALLOC_CTX *mem_ctx, uint32_t lba, uint32_t xferlen, int blocksize, int wrprotect, int dpo, int bytchk, int group_number);
EXTERN struct scsi_task *scsi_cdb_writeverify16(TALLOC_CTX *mem_ctx, uint64_t lba, uint32_t xferlen, int blocksize, int wrprotect, int dpo, int bytchk, int group_number);
EXTERN struct scsi_task *scsi_cdb_verify10(TALLOC_CTX *mem_ctx, uint32_t lba, uint32_t xferlen, int vprotect, int dpo, int bytchk, int blocksize);
EXTERN struct scsi_task *scsi_cdb_verify12(TALLOC_CTX *mem_ctx, uint32_t lba, uint32_t xferlen, int vprotect, int dpo, int bytchk, int blocksize);
EXTERN struct scsi_task *scsi_cdb_verify16(TALLOC_CTX *mem_ctx, uint64_t lba, uint32_t xferlen, int vprotect, int dpo, int bytchk, int blocksize);

EXTERN struct scsi_task *scsi_cdb_synchronizecache10(TALLOC_CTX *mem_ctx, int lba, int num_blocks,
			int syncnv, int immed);
EXTERN struct scsi_task *scsi_cdb_synchronizecache16(TALLOC_CTX *mem_ctx, uint64_t lba, uint32_t num_blocks,
			int syncnv, int immed);
EXTERN struct scsi_task *scsi_cdb_serviceactionin16(TALLOC_CTX *mem_ctx, enum scsi_service_action_in sa, uint32_t xferlen);
EXTERN struct scsi_task *scsi_cdb_readcapacity16(TALLOC_CTX *mem_ctx);
EXTERN struct scsi_task *scsi_cdb_get_lba_status(TALLOC_CTX *mem_ctx, uint64_t starting_lba, uint32_t alloc_len);
EXTERN struct scsi_task *scsi_cdb_unmap(TALLOC_CTX *mem_ctx, int anchor, int group, uint16_t xferlen);
EXTERN struct scsi_task *scsi_cdb_persistent_reserve_in(TALLOC_CTX *mem_ctx, enum scsi_persistent_in_sa sa, uint16_t xferlen);
EXTERN struct scsi_task *scsi_cdb_persistent_reserve_out(TALLOC_CTX *mem_ctx, enum scsi_persistent_out_sa sa, enum scsi_persistent_out_scope scope, enum scsi_persistent_out_type type, void *params);
EXTERN struct scsi_task *scsi_cdb_writesame10(TALLOC_CTX *mem_ctx, int wrprotect, int anchor, int unmap, int pbdata, int lbdata, uint32_t lba, int group, uint16_t num_blocks);
EXTERN struct scsi_task *scsi_cdb_writesame16(TALLOC_CTX *mem_ctx, int wrprotect, int anchor, int unmap, int pbdata, int lbdata, uint64_t lba, int group, uint32_t num_blocks);
EXTERN struct scsi_task *scsi_cdb_prefetch10(TALLOC_CTX *mem_ctx, uint32_t lba, int num_blocks, int immed, int group);
EXTERN struct scsi_task *scsi_cdb_prefetch16(TALLOC_CTX *mem_ctx, uint64_t lba, int num_blocks, int immed, int group);
EXTERN struct scsi_task *scsi_cdb_report_supported_opcodes(TALLOC_CTX *mem_ctx, int report_timeouts, uint32_t alloc_len);
