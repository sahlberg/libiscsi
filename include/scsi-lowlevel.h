...
struct scsi_task {
	...
	union {
		...
		struct scsi_orwrite16_params       orwrite16;
...
EXTERN struct scsi_task *scsi_cdb_orwrite16(uint64_t lba, uint32_t xferlen, int blocksize, int wrprotect, int dpo, int fua, int fua_nv, int group_number);
