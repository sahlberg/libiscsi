...
EXTERN struct scsi_task *scsi_cdb_writesame10(TALLOC_CTX *mem_ctx, int wrprotect, int anchor, int unmap, uint32_t lba, int group, uint16_t num_blocks);
EXTERN struct scsi_task *scsi_cdb_writesame16(TALLOC_CTX *mem_ctx, int wrprotect, int anchor, int unmap, uint64_t lba, int group, uint32_t num_blocks);
