...
int T0243_prefetch10_0blocks(const char *initiator, const char *url, int data_loss, int show_info);
...
int T0253_prefetch16_0blocks(const char *initiator, const char *url, int data_loss, int show_info);
