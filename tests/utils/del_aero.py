...
print ("Send POST stord_svc del_aero 1")
r = requests.post("%s://127.0.0.1:9000/stord_svc/v1.0/del_aero/?aero-id=1" % h, data=json.dumps(data1), headers=headers, cert=cert, verify=False)
